...
export async function stopProjectChat(projectId: string, messageId: string) {
  await cloudOperation().request(`/api/projects/${projectId}/messages/stop`, z.object({ stopped: z.literal(true) }), 'POST', { messageId })
}
